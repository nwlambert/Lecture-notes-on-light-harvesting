...
cdef complex spectral0(double w, double t): return   2.0 * 0.05 / (pi * 10.0 * 2.5448096943108576e-14)  if (w==0) else (2.0*0.05*10.0 *w /(pi*(w**2+10.0**2))) * ((1/(exp((w) * 2.5448096943108576e-14)-1))+1)
